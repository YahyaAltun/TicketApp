...
public class TripService {
    ...
    public List<Trip> searchTripByParameters(TripDTO tripDTO){
        return tripRepository.findTripByTripFromOrTripToOrTimeTripFromOrTimeTripToOrBusIdOrPlaneIdOrTripPrice(
                tripDTO.getTripFrom(),tripDTO.getTripTo(),tripDTO.getTimeTripFrom(),tripDTO.getTimeTripTo(),tripDTO.getBusId(),tripDTO.getPlaneId(), tripDTO.getTripPrice());
    }
